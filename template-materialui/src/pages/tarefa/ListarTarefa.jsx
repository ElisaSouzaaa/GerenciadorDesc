...
const initialRows = [
  ...
  createData(2, 'Tarefa 2', 'Descrição da Tarefa 2', '2024-05-03', '2024-06-04', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Tarefa 3', 'Descrição da Tarefa 3', '2024-05-04', '2024-06-05', 'Em Andamento', 'Recurso 3'),
  createData(4, 'Tarefa 4', 'Descrição da Tarefa 4', '2024-05-05', '2024-06-06', 'Em Andamento', 'Recurso 4'),
  createData(5, 'Tarefa 5', 'Descrição da Tarefa 5', '2024-05-06', '2024-06-07', 'Em Andamento', 'Recurso 5'),
  createData(6, 'Tarefa 6', 'Descrição da Tarefa 6', '2024-06-07', '2024-07-08', 'Aguardando', 'Recurso 6'),
];
...
const ListarTarefa = () => {
  ...
  const handleCancelarMouseEnter = () => {
    setHoverCancelar(true);
  };

  const handleCancelarMouseLeave = () => {
    setHoverCancelar(false);
  };
  ...
  return (
    <>
      <Card>
        <CardHeader
          title="Suas tarefas"
          subheader="Lista das suas Tarefas"
        />
        <CardContent>
        ...
        <CardActions>
          ...
          <Button
            size="small"
            variant="outlined"
            onMouseEnter={handleCancelarMouseEnter}
            onMouseLeave={handleCancelarMouseLeave}
            style={{ backgroundColor: hoverCancelar ? 'red' : '' }}
          >
            Cancelar
          </Button>
        </CardActions>
